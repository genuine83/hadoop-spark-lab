...
RUN wget -P /tmp/ https://archive.apache.org/dist/spark/spark-2.3.2/spark-2.3.2-bin-hadoop2.7.tgz
RUN tar xvf /tmp/spark-2.3.2-bin-hadoop2.7.tgz -C /tmp && \
    mv /tmp/spark-2.3.2-bin-hadoop2.7 ${SPARK_HOME}
